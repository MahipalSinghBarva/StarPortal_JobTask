...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-black max-h-full">
      <div className="mx-auto max-w-screen-2l px-16 py-20 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          <div className="text-teal-600 dark:text-teal-300"></div>

          <div className=" grid grid-cols-2 gap-2 lg:mt-0 lg:grid-cols-6 lg:gap-y-16 px-32">
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  We are your personal guide for exploring web3 project &
      ...
      <div className="py-10 px-20 border-t border-gray-100 pt-8 dark:border-gray-800 ">
      ...
      <div className="py-5 px-20 border-t border-gray-100 pt-8 dark:border-gray-800">
        <div className="sm:flex sm:justify-between">
          <p className="text-xl text-gray-500 dark:text-white">
            CREATED BY <span className="underline">INTRECT</span>
          </p>
          ...
          <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75 dark:text-blue-500 "
              >
